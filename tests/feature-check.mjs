...
const checks=[
 ...
 ['hero usa referencia final sin fallback visible',()=>read('storefront-reference-hero.js').includes('pilar-hero-reference-mobile.webp?v=20260917-hero-final-4')&&!read('storefront-reference-hero.js').includes('sf-ref-image-fallback')&&!read('storefront-reference-hero.js').includes('Tu estilo. Tu tiempo.</span>')],
