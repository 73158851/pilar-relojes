...
const checks=[
 ...
 ['hero usa referencia visual',()=>read('storefront.js').includes('sf-hero-reference')&&read('storefront-reference-hero.css').includes('/pilar-hero-reference.webp')],
 ['hero mantiene botones funcionales',()=>read('storefront.js').includes('sf-hero-hotspot catalog')&&read('storefront.js').includes('sf-hero-hotspot whatsapp')],
 ['hero tiene animaciones premium',()=>read('storefront-reference-hero.css').includes('@keyframes heroReferenceReveal')&&read('storefront-reference-hero.css').includes('@keyframes heroHotspotPulse')],
 ['solo hero integra nuevo css',()=>read('index.html').includes('storefront-reference-hero.css')],
