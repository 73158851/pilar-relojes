...
const obs=new MutationObserver(()=>{rememberInitialSku();addAdminToolbar();addDashboardAttention();} );obs.observe(document.getElementById('app'),{childList:true,subtree:true});
