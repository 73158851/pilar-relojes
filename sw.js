...
self.addEventListener('fetch',event=>{
  ...
  if(url.origin===self.location.origin&&(url.pathname==='/pilar-hero-approved-v3.webp'||url.pathname==='/pilar-hero-approved-v2.webp'||url.pathname==='/pilar-hero-approved.webp'||url.pathname==='/pilar-hero-exact-reference.webp'||url.pathname==='/pilar-hero-reference-mobile.webp')){
