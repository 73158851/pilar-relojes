function enhanceHero(){
  ...
  hero.dataset.referenceHero='final-mobile-v2';
  hero.className='sf-hero sf-hero-reference sf-ref-exact';
  hero.innerHTML=`<div class="sf-ref-exact-frame">
    <img class="sf-ref-exact-image" src="/pilar-hero-reference-mobile.webp?v=20260917-final-mobile-2" alt="PILAR — Tu estilo. Tu tiempo." decoding="sync" fetchpriority="high">
