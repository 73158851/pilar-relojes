function enhanceHero(){
  ...
  hero.dataset.referenceHero='verified-v2';
  hero.className='sf-hero sf-hero-reference sf-ref-exact';
  hero.innerHTML=`<div class="sf-ref-exact-frame">
    <img class="sf-ref-exact-image" src="/pilar-hero-approved-v2.webp?v=20260918-verified-2" alt="PILAR — Tu estilo. Tu tiempo." decoding="sync" fetchpriority="high">
