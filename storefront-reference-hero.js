function enhanceHero(){
  ...
  hero.dataset.referenceHero='localvalidated-v3';
  hero.className='sf-hero sf-hero-reference sf-ref-exact';
  hero.innerHTML=`<div class="sf-ref-exact-frame">
    <img class="sf-ref-exact-image" src="/pilar-hero-approved-v3.webp?v=20260918-localvalidated-3" alt="PILAR — Tu estilo. Tu tiempo." decoding="sync" fetchpriority="high">
